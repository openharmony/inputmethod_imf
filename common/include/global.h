...
enum {
    ...
    ERROR_JS_PARAM,                // ONLY FOT HISYS REPORT
    ERROR_JS_CB_NOT_REGISTER,       // ONLY FOT HISYS REPORT
    ERROR_DEAL_TIMEOUT,              // ONLY FOT HISYS REPORT
    ERROR_IPC_REMOTE_NULLPTR,        // EXCEPTION_IMMS

    ERROR_IMA_BEGIN,
    ERROR_IME,
    ERROR_OPERATE_PANEL,
    ERROR_IMA_CHANNEL_NULLPTR,          // JS:EXCEPTION_IMCLIENT
    ERROR_IMA_NULLPTR,                // TODO JS:EXCEPTION_IMMS
    ERROR_IMA_END,
    ...
    ERROR_IMSA_INPUT_TYPE_NOT_FOUND,// ERRIMMS
    ERROR_IMSA_DEFAULT_IME_NOT_FOUND,// ERRIMMS
    ERROR_IMSA_CLIENT_INPUT_READY_FAILED,  // ERRIMMS
    ERROR_IMSA_MALLOC_FAILED,// ERRIMMS
    ERROR_IMSA_NULLPTR,  // TODO JS:EXCEPTION_IMMS
    ERROR_IMSA_USER_SESSION_NOT_FOUND, // ERRIMMS,
    ERROR_IMSA_GET_IME_INFO_FAILED, // ERRIMMS
    ERROR_IMSA_IME_TO_START_NULLPTR,  //ERRIMMS
    ERROR_IMSA_REBOOT_OLD_IME_NOT_STOP,//ERRIMMS
    ERROR_IMSA_IME_EVENT_CONVERT_FAILED,//ERRIMMS
    ERROR_IMSA_AMS_CONNECT_FAILED,//ERRIMMS
    ERROR_IMSA_AMS_DISCONNECT_FAILED,//ERRIMMS
    ERROR_IMSA_IME_START_TIMEOUT,//ERRIMMS
    ERROR_IMSA_IME_START_MORE_THAN_EIGHT_SECOND,//ERRIMMS
    ERROR_IMSA_FORCE_STOP_IME_TIMEOUT,//ERRIMMS
    ERROR_IMSA_END,
};
}; // namespace ErrorCode
