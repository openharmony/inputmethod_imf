...
enum {
    ...
    ERROR_IMC_NULLPTR,
    ERROR_IMC_SERVICE_RESPONSE_TIMEOUT,
    ERROR_REQUEST_INTERRUPTED,
    ERROR_IMC_END,
    ...
    ERROR_IMSA_REQUESTER_NOT_FOUND,
    ERROR_IMSA_TASK_TIMEOUT,
    ERROR_SA_TASK_MANAGER_PEND_ACTION_FAILED,
    ERROR_IMSA_REQUEST_COUNT_OVER_MAXIMUM,
    ERROR_SA_POST_TASK_FAILED,
