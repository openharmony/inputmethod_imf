...
ImaResponseChannelImpl::ImaResponseChannelImpl()
{
}
...
ErrCode ImaResponseChannelImpl::OnResponse(
    uint32_t requestId, int32_t resultErrCode, const ServiceResponseDataInner &response)
{
    ...
    ImaServiceProxy::GetInstance().OnResponse(requestId, serviceResponse);
    return ERR_OK;
}
} // namespace MiscServices
} // namespace OHOS