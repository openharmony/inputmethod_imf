...
#ifndef FRAMEWORKS_ETS_TAIHE_INPUT_METHOD_EVENT_LISTENER_H
...
public:
    ...
    void OnImeChangeWithUserId(const Property &property, const SubProperty &subProperty, int32_t userId);
