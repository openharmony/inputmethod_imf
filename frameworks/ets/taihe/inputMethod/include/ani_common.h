...
private:
    ...
    static InputMethodProperty_t ConvertPropertyImpl(T &&obj)
    {
        ...
        result.labelId = taihe::optional<long>(std::in_place_t{}, static_cast<long long>(obj.labelId));
        result.icon = taihe::optional<taihe::string>(std::in_place_t{}, obj.icon);
        result.iconId = taihe::optional<long>(std::in_place_t{}, static_cast<long long>(obj.iconId));
        return result;
    }
