...
private:
    ...
    static napi_value JsGetKeyboardStatusProperty(napi_env env);
    static napi_value JsGetEnterKeyTypeProperty(napi_env env);
    static napi_value JsGetTextInputTypeProperty(napi_env env);
