...
const std::map<int32_t, int32_t> JsUtils::ERROR_CODE_MAP = {
    ...
    { ErrorCode::ERROR_IPC_IMSA_ABNORMAL, EXCEPTION_IMMS },
    { ErrorCode::ERROR_IMSA_USER_SESSION_NOT_FOUND, EXCEPTION_IMMS },
    { ErrorCode::ERROR_IMSA_IPC_IMA_ABNORMAL, EXCEPTION_IMMS },
    { ErrorCode::ERROR_IMSA_IPC_IMC_ABNORMAL, EXCEPTION_IMMS },
};
