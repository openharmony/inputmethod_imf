...
public:
    ...
    static int32_t Attach(const bool &showKeyboard, const CTextConfig &txtCfg);
    static int32_t Detach();
    static int32_t ShowTextInput();
    static int32_t HideTextInput();
    static int32_t SetCallingWindow(const uint32_t &windowId);
