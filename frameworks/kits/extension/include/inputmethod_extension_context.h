...
public:
     ...
     * An ability using the AbilityInfo.AbilityType.INPUTMETHOD or AbilityInfo.AbilityType.PAGE template uses this method
    ...
    /**
     * @brief Connects the current ability to an ability using the AbilityInfo.AbilityType.INPUTMETHOD template.
     *
