...
public:
    ...
    bool SubscribeScreenLockMgrService(const Handler &handler);
    ...
    public:
        ...
        void OnScreenLocked(const EventFwk::CommonEventData &data);
        void OnScreenUnlocked(const EventFwk::CommonEventData &data);
