...
void FreezeManager::ReportRss(bool shouldFreeze, pid_t pid, bool isDelay)
{
...
void FreezeManager::PasteBoardActiveIme()
{
    IMSA_HILOGI("Pasteboard active IME");
    ReportRss(false, pid_, true);
}
} // namespace MiscServices
} // namespace OHOS
